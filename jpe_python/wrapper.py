...
class ControllerContext:
    ...
    def with_network(cls, ip: str):
        ...
        return ControllerContext(
            jpe_python_ffi.BaseContextBuilder().with_network(ip).build()
        )
    ...
    def set_ip_config(
        self, addr_mode: IpAddrMode, ip_addr: str, mask: str, gateway: str
    ) -> str:
        """
    ...
    def move_stage_open(
        ...
        CADM2 modules.
        """
        return self._inner.move_stage_open(
    ...
    def enable_ext_input_mode(
        ...
        """
        return self._inner.enable_ext_input_mode(
    ...
    def get_current_position_all(
        ...
        """
        return self._inner.get_current_position_all(
            slot, stage_ch1, stage_ch2, stage_ch3
        )
    ...
    def enable_servodrive(
        ...
        """
        return self._inner.enable_servodrive(
            stage_1,
            init_step_freq_1,
            stage_2,
            init_step_freq_2,
    ...
    def go_to_setpoint(
        ...
        When using RLS / RSM: absolute positioning is relative to the center of the stage, whereas relative
        positioning is relative to the current position.
        """
        return self._inner.go_to_setpoint(
